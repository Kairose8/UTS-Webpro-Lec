...
<body class="h-screen bg-gray-100">
    ...
    <div id="main-content" class="transition-all duration-300 ml-0 pl-0">
        ...
        <div class="flex justify-center my-8">
            <input type="text" id="search" name="search" class="w-full md:w-1/2 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-600 focus:border-blue-600" placeholder="Search events" value="<?= htmlspecialchars($searchQuery) ?>" />
